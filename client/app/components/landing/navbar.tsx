    ...
    >
      <div className="w-full max-w-[1800px] mx-auto px-5 sm:px-8 md:px-12 lg:px-16 xl:px-20">
        <nav className="flex items-center justify-between gap-4" aria-label="Main Navigation">
          {/* Left: Brand Logo + PlusOnne Text with Gradient */}
          <Link
            href="/"
          ...
          <div className="hidden sm:flex items-center gap-3 md:gap-4 shrink-0">
            ...
            <div className="relative" ref={cityDropdownRef}>
              ...
              {isCityDropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 rounded-2xl bg-[#111420]/95 backdrop-blur-xl border border-white/10 shadow-2xl py-2 z-50 animate-in fade-in zoom-in-95 duration-150">
                  <div className="px-3 py-1.5 text-[11px] font-semibold uppercase tracking-wider text-zinc-500 flex items-center justify-between">
            ...
            <Link
              href="/auth/login"
              className="relative inline-flex items-center justify-center px-5 py-2 rounded-full text-xs sm:text-sm font-semibold text-white bg-gradient-to-r from-[#FF6A3D] via-[#FF4E6E] to-[#9B51E0] hover:opacity-95 shadow-lg shadow-rose-500/20 transition-all duration-200 hover:scale-[1.03] active:scale-[0.97]"
            >
