    ...
    <section id="home" className="relative overflow-hidden pt-12 pb-24 lg:pt-20 lg:pb-32">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-white/[0.05] border border-white/10 text-xs sm:text-sm text-zinc-300 mb-8 backdrop-blur-md shadow-inner">
          ...
          <span className="text-orange-300 font-medium">DigiLocker Verified</span>
        </div>
        ...
        <p className="mt-6 text-lg sm:text-xl text-zinc-300 max-w-3xl mx-auto font-normal leading-relaxed">
          Combatting urban loneliness for corporate professionals, students, & seniors. Connect with trained, background-checked hosts for coffee dates, city tours, gym sessions, or formal gala +1s.
        </p>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <a
            href="#packages"
            className="px-8 py-4 rounded-full text-sm font-semibold text-white bg-gradient-to-r from-[#FF6A3D] via-[#FF4E6E] to-[#9B51E0] shadow-xl shadow-rose-500/25 hover:opacity-95 transition-all hover:scale-105"
          >
          ...
          <a
            href="/host/apply"
            className="px-6 py-4 rounded-full text-sm font-semibold text-amber-300 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/20 transition-all"
          >
            Become a Host (Earn ₹30k/mo)
          </a>
        </div>
        ...
        <div className="mt-16 pt-10 border-t border-white/[0.08] max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          ...
          <div className="space-y-1">
            <div className="text-2xl sm:text-3xl font-extrabold text-amber-400 font-outfit">4.95 ★</div>
            <div className="text-xs text-zinc-400 font-medium">Average Guest Rating</div>
          </div>
          <div className="space-y-1">
            <div className="text-2xl sm:text-3xl font-extrabold text-cyan-400 font-outfit">50+</div>
            <div className="text-xs text-zinc-400 font-medium">Daily Completed Services</div>
          </div>
          <div className="space-y-1">
            <div className="text-2xl sm:text-3xl font-extrabold text-emerald-400 font-outfit">100%</div>
